...
public class OpenCLInitDeclaratorListImpl extends ASTWrapperPsiElement implements OpenCLInitDeclaratorList {

  public OpenCLInitDeclaratorListImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public OpenCLInitDeclarator getInitDeclarator() {
    return findNotNullChildByClass(OpenCLInitDeclarator.class);
  }
