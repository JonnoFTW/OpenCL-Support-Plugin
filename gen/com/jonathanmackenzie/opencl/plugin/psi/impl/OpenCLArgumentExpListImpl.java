...
public class OpenCLArgumentExpListImpl extends ASTWrapperPsiElement implements OpenCLArgumentExpList {

  public OpenCLArgumentExpListImpl(ASTNode node) {
    super(node);
  }
  ...
  public OpenCLAssignmentExp getAssignmentExp() {
    return findNotNullChildByClass(OpenCLAssignmentExp.class);
  }
