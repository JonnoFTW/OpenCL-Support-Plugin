...
public class OpenCLParamTypeListImpl extends ASTWrapperPsiElement implements OpenCLParamTypeList {

  public OpenCLParamTypeListImpl(ASTNode node) {
    super(node);
  }
  ...
  public OpenCLParamList getParamList() {
    return findNotNullChildByClass(OpenCLParamList.class);
  }
