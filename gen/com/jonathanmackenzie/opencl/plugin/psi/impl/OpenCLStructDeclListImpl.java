...
public class OpenCLStructDeclListImpl extends ASTWrapperPsiElement implements OpenCLStructDeclList {

  public OpenCLStructDeclListImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public OpenCLStructDecl getStructDecl() {
    return findNotNullChildByClass(OpenCLStructDecl.class);
  }
