...
public class OpenCLMultExpImpl extends ASTWrapperPsiElement implements OpenCLMultExp {

  public OpenCLMultExpImpl(ASTNode node) {
    super(node);
  }
  ...
  public OpenCLCastExp getCastExp() {
    return findNotNullChildByClass(OpenCLCastExp.class);
  }

  @Override
  @Nullable
  public OpenCLMultExp getMultExp() {
    return findChildByClass(OpenCLMultExp.class);
  }
