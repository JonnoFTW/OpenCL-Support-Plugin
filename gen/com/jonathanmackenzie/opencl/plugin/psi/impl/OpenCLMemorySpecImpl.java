...
public class OpenCLMemorySpecImpl extends ASTWrapperPsiElement implements OpenCLMemorySpec {

  public OpenCLMemorySpecImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OpenCLVisitor visitor) {
    visitor.visitMemorySpec(this);
  }
