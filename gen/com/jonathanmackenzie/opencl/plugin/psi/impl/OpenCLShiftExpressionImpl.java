...
public class OpenCLShiftExpressionImpl extends ASTWrapperPsiElement implements OpenCLShiftExpression {

  public OpenCLShiftExpressionImpl(ASTNode node) {
    super(node);
  }
  ...
  public OpenCLAdditiveExp getAdditiveExp() {
    return findNotNullChildByClass(OpenCLAdditiveExp.class);
  }

  @Override
  @Nullable
  public OpenCLShiftExpression getShiftExpression() {
    return findChildByClass(OpenCLShiftExpression.class);
  }
