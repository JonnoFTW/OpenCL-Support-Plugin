...
public class OpenCLParamListImpl extends ASTWrapperPsiElement implements OpenCLParamList {

  public OpenCLParamListImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public OpenCLParamDecl getParamDecl() {
    return findNotNullChildByClass(OpenCLParamDecl.class);
  }

  @Override
  @Nullable
  public OpenCLParamList getParamList() {
    return findChildByClass(OpenCLParamList.class);
  }
