...
public class OpenCLAdditiveExpImpl extends ASTWrapperPsiElement implements OpenCLAdditiveExp {

  public OpenCLAdditiveExpImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public OpenCLAdditiveExp getAdditiveExp() {
    return findChildByClass(OpenCLAdditiveExp.class);
  }

  @Override
  @NotNull
  public OpenCLMultExp getMultExp() {
    return findNotNullChildByClass(OpenCLMultExp.class);
  }
