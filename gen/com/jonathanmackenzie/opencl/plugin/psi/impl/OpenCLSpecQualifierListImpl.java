...
public class OpenCLSpecQualifierListImpl extends ASTWrapperPsiElement implements OpenCLSpecQualifierList {

  public OpenCLSpecQualifierListImpl(ASTNode node) {
    super(node);
  }
  ...
  public OpenCLSpecQualifierList getSpecQualifierList() {
    return findChildByClass(OpenCLSpecQualifierList.class);
  }
