...
public class OpenCLConstExpImpl extends ASTWrapperPsiElement implements OpenCLConstExp {

  public OpenCLConstExpImpl(ASTNode node) {
    super(node);
  }
  ...
  public OpenCLConditionalExp getConditionalExp() {
    return findNotNullChildByClass(OpenCLConditionalExp.class);
  }
