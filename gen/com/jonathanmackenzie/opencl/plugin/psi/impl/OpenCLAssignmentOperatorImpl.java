...
public class OpenCLAssignmentOperatorImpl extends ASTWrapperPsiElement implements OpenCLAssignmentOperator {

  public OpenCLAssignmentOperatorImpl(ASTNode node) {
    super(node);
  }
