...
public class OpenCLPrimaryExpImpl extends ASTWrapperPsiElement implements OpenCLPrimaryExp {

  public OpenCLPrimaryExpImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public OpenCLConst getConst() {
    return findChildByClass(OpenCLConst.class);
  }
